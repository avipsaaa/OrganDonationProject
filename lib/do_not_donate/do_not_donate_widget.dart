...
class DoNotDonateWidget extends StatefulWidget {
  const DoNotDonateWidget({Key key}) : super(key: key);

  @override
  _DoNotDonateWidgetState createState() => _DoNotDonateWidgetState();
}

class _DoNotDonateWidgetState extends State<DoNotDonateWidget> {
  DateTime datePicked;
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          'Register a decision to not donate',
