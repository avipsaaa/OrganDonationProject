...
class SupportUsWidget extends StatefulWidget {
  const SupportUsWidget({Key key}) : super(key: key);

  @override
  _SupportUsWidgetState createState() => _SupportUsWidgetState();
}

class _SupportUsWidgetState extends State<SupportUsWidget> {
